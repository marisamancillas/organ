...
# Objective:
Overall Objective: This script was written to harmonize as much plant species occurrence data as possible for the Organ Mountains in south-central New Mexico(-106.6418 W, 32.1589 N, -106.4665 W, 32.42757 N).
...
```{r functions}
# housekeeping function: turn dataframe to charactor type, and lowercase, 
...
sfpoly <- st_read("./boundary_for_herbarium_occurrences")
...
# keep all information from all rows from that unique duplicate
# and synthesize that into one record (one row)
...
write_excel_csv(df, "all_six_institutions_combined_11_25_22.csv")
